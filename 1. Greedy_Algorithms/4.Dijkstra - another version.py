...
"""
The basic runtime of Dijkstra is O(|V^2|) number of vertices power 2
bcz in the worst case we're using every node in the graph once or twice and everytime we search in the queue
to find the minimum

There are many  optimizations of Dijkstra's algorithm, if priority queue implemented efficiently, it can take:
O(|E| + |v|log|v|)
"""
